...
const projects=[
 {name:'LayerZero',type:'Airdrop',coin:'ZRO',stake:'$0',profit:{50:'$100–$500',100:'$100–$500',500:'$100–$500',1000:'$100–$500'},siteUrl:'https://layerzero.network/',actionUrl:'https://stargate.finance/',steps:['Подключить кошелёк', 'Сделать bridge между сетями', 'Использовать LayerZero dApps', 'Повторить активность несколько раз'],cost:'$0–20 на комиссии',guideSteps:["Открыть Stargate", "Подключить отдельный кошелёк", "Сделать bridge USDC/ETH между 2–3 сетями", "Повторить 3–5 транзакций в разные дни", "Проверить новые кампании LayerZero"],counts:["Bridge между сетями", "Swap/transfer через Stargate", "Активность в разные дни"],chance:"Высокий шанс, если делать активность регулярно",beginner:"Новичок справится, но нужны комиссии в сетях."},roi:'Высокий',score:91,status:'active',statusText:'Active',startDate:'2026-06-01',endDate:'2026-07-15',cat:['best','free','potential','funds'],funds:['a16z','Sequoia','PayPal'],fundsCount:11,time:'10–20 мин',difficulty:'Легко',icon:'L0',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=layerzero.network'},
 {name:'Monad',type:'Testnet',coin:'MON',stake:'$0',profit:{50:'$50–$300',100:'$50–$300',500:'$50–$300',1000:'$50–$300'},siteUrl:'https://monad.xyz/',actionUrl:'https://testnet.monad.xyz/',steps:['Открыть тестнет Monad', 'Подключить кошелёк', 'Выполнить задания экосистемы', 'Сохранить активность кошелька'],cost:'$0',guideSteps:["Открыть Monad testnet", "Подключить кошелёк", "Получить тестовые токены", "Сделать swap/transfer", "Пройти доступные задания экосистемы"],counts:["Testnet transactions", "Swap", "Quest activity"],chance:"Высокий потенциал, но награда не гарантирована",beginner:"Подходит новичку, если есть кошелёк."},roi:'Высокий',score:89,status:'active',statusText:'Active',startDate:'2026-06-10',endDate:'2026-07-30',cat:['best','free','potential','funds'],funds:['Paradigm','Electric'],fundsCount:9,time:'20–40 мин',difficulty:'Средняя',icon:'M',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=monad.xyz'},
 {name:'Berachain',type:'Testnet',coin:'BERA',stake:'$0',profit:{50:'$80–$400',100:'$80–$400',500:'$80–$400',1000:'$80–$400'},siteUrl:'https://www.berachain.com/',actionUrl:'https://bepolia.faucet.berachain.com/',steps:['Открыть тестнет Berachain', 'Получить тестовые токены', 'Сделать swap / stake / liquidity', 'Повторить действия в dApps'],cost:'$0',guideSteps:["Открыть сайт Berachain", "Подключить кошелёк", "Получить тестовые токены", "Сделать swap", "Добавить ликвидность или выполнить задания экосистемы"],counts:["Swap", "Liquidity", "Тестнет-транзакции", "Квесты экосистемы"],chance:"Средний/высокий шанс за активный тестнет",beginner:"Нужны базовые знания testnet и faucet."},roi:'Высокий',score:90,status:'ending',statusText:'Ending Soon',startDate:'2026-05-28',endDate:'2026-06-28',cat:['best','free','potential','funds'],funds:['Polychain','Framework'],fundsCount:10,time:'20–30 мин',difficulty:'Средняя',icon:'B',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=berachain.com'},
 {name:'ZetaChain',type:'Testnet',coin:'ZETA',stake:'$0',profit:{50:'$20–$100',100:'$20–$100',500:'$20–$100',1000:'$20–$100'},siteUrl:'https://www.zetachain.com/',actionUrl:'https://hub.zetachain.com/',steps:['Открыть ZetaHub', 'Подключить кошелёк', 'Сделать кросс-чейн действия', 'Проверить задания'],cost:'$0–10',guideSteps:["Открыть ZetaHub", "Подключить MetaMask", "Получить тестовые токены", "Сделать cross-chain swap", "Проверить задания и повторить активность"],counts:["Cross-chain действия", "Swap", "Bridge", "Повторная активность"],chance:"Средний шанс, зависит от активности кошелька",beginner:"Лёгкий формат, но нужен кошелёк."},roi:'Средний',score:92,status:'active',statusText:'Active',startDate:'2026-06-05',endDate:'2026-07-05',cat:['best','free','potential','funds'],funds:['Blockchain.com','Jane Street'],fundsCount:6,time:'15–20 мин',difficulty:'Легко',icon:'Z',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=zetachain.com'},
 {name:'Initia',type:'Testnet',coin:'INIT',stake:'$0',profit:{50:'$40–$220',100:'$40–$220',500:'$40–$220',1000:'$40–$220'},siteUrl:'https://initia.xyz/',actionUrl:'https://app.testnet.initia.xyz/',steps:['Открыть Initia testnet', 'Подключить кошелёк', 'Выполнить задания', 'Проверить прогресс'],cost:'$0',guideSteps:["Открыть Initia testnet", "Подключить кошелёк", "Получить faucet", "Сделать транзакции", "Выполнить задания в приложениях Initia"],counts:["Faucet", "Тестнет-транзакции", "Quest activity"],chance:"Средний шанс, если выполнять задания регулярно",beginner:"Хорошо подходит новичку."},roi:'Высокий',score:85,status:'active',statusText:'Active',startDate:'2026-06-08',endDate:'2026-07-20',cat:['free','potential','funds'],funds:['Binance Labs','Delphi'],fundsCount:5,time:'10–15 мин',difficulty:'Легко',icon:'I',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=initia.xyz'},
 {name:'Manta Network',type:'Airdrop',coin:'MANTA',stake:'$0',profit:{50:'$30–$150',100:'$30–$150',500:'$30–$150',1000:'$30–$150'},siteUrl:'https://manta.network/',actionUrl:'https://newparadigm.manta.network/',steps:['Открыть портал Manta', 'Подключить кошелёк', 'Проверить кампании', 'Выполнить задания'],cost:'$0–20',guideSteps:["Открыть портал Manta", "Подключить кошелёк", "Проверить активные кампании", "Выполнить задания", "Сохранить активность кошелька"],counts:["Quest", "Bridge/Deposit если требуется", "Активность в кампании"],chance:"Средний шанс, зависит от текущей кампании",beginner:"Нужна внимательность к условиям кампании."},roi:'Средний',score:86,status:'active',statusText:'Active',startDate:'2026-06-03',endDate:'2026-07-10',cat:['free','potential','funds'],funds:['Binance Labs','Polychain'],fundsCount:6,time:'15–25 мин',difficulty:'Средняя',icon:'M',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=manta.network'},
 {name:'Movement',type:'Testnet',coin:'MOVE',stake:'$0',profit:{50:'$30–$180',100:'$30–$180',500:'$30–$180',1000:'$30–$180'},siteUrl:'https://movementlabs.xyz/',actionUrl:'https://movementlabs.xyz/',steps:['Открыть сайт Movement', 'Проверить testnet / quests', 'Подключить кошелёк', 'Выполнить активности'],cost:'$0',guideSteps:["Открыть Movement", "Проверить testnet/quests", "Подключить кошелёк", "Выполнить доступные действия", "Повторить активность через несколько дней"],counts:["Testnet", "Quest", "Активность кошелька"],chance:"Средний шанс за раннее участие",beginner:"Лёгкий вариант для старта."},roi:'Средний',score:84,status:'active',statusText:'Active',startDate:'2026-06-12',endDate:'2026-08-01',cat:['free','potential','funds'],funds:['Polychain','Binance Labs'],fundsCount:7,time:'15 мин',difficulty:'Легко',icon:'MV',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=movementlabs.xyz'},
 {name:'MegaETH',type:'Airdrop',coin:'MEGA',stake:'$0',profit:{50:'$60–$250',100:'$60–$250',500:'$60–$250',1000:'$60–$250'},siteUrl:'https://megaeth.com/',actionUrl:'https://megaeth.com/',steps:['Открыть MegaETH', 'Проверить testnet / waitlist', 'Подключить кошелёк или X', 'Выполнить задания'],cost:'$0',guideSteps:["Открыть сайт MegaETH", "Проверить waitlist/testnet", "Подключить кошелёк или X", "Выполнить доступные задания", "Следить за новыми этапами"],counts:["Waitlist", "Testnet/Quest если открыт", "Социальная активность"],chance:"Высокий потенциал, но активность может открываться этапами",beginner:"Пока лучше следить за доступными заданиями."},roi:'Высокий',score:88,status:'active',statusText:'Active',startDate:'2026-06-15',endDate:'2026-08-15',cat:['best','free','potential','funds'],funds:['Dragonfly','Figment'],fundsCount:8,time:'20 мин',difficulty:'Средняя',icon:'ME',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=megaeth.com'},
 {name:'Kelp DAO',type:'Staking',coin:'KELP',stake:'от $10',profit:{50:'$20–$80',100:'$40–$160',500:'$200–$800',1000:'$400–$1600',siteUrl:'https://kelpdao.xyz/',actionUrl:'https://app.kelpdao.xyz/',steps:['Открыть Kelp DAO app', 'Подключить кошелёк', 'Выбрать restaking', 'Учитывать риски депозита'],cost:'от $10',guideSteps:["Открыть Kelp DAO app", "Подключить кошелёк", "Выбрать restaking", "Проверить риски и комиссии", "Сделать депозит только если понимаешь риск"],counts:["Restaking", "Deposit", "Points activity"],chance:"Средний шанс, но нужен депозит",beginner:"Не для новичка без понимания DeFi-рисков."},roi:'Средний',score:87,status:'active',statusText:'Active',startDate:'2026-06-01',endDate:'2026-09-01',cat:['best','deposit','funds'],funds:['Laser Digital','SCB'],fundsCount:7,time:'5 мин',difficulty:'Легко',icon:'K',logoUrl:'https://www.google.com/s2/favicons?sz=128&domain=kelpdao.xyz'}
];
...
function detailsModal(){
 ...
 if(!o) return '';
 const profit=o.profit[deposit]||o.profit[500];
 const steps=o.guideSteps||o.steps||[];
 ...
 return `<div class="modal show detailsModal" id="details"><div class="sheet detailsSheet">
  ...
  <div class="aiHint"><b>🤖 Пошаговая инструкция</b><span>${o.beginner||'Сделай шаги ниже и проверь условия проекта.'}</span></div>
  <div class='checklist'><label><input type='checkbox'> Кошелёк подключён</label><label><input type='checkbox'> Получен faucet</label><label><input type='checkbox'> Сделан swap</label><label><input type='checkbox'> Выполнен квест</label></div><h3>Что делать</h3>
  <ol class="steps guideSteps">${steps.map(s=>`<li>${s}</li>`).join('')}</ol>
  <h3>Какие действия засчитываются</h3>
  <div class="countTags">${counts.map(s=>`<span>${s}</span>`).join('')}</div>
  <h3>Шанс награды</h3>
  <p class="chance">${o.chance||'Награда не гарантирована. Чем регулярнее активность, тем лучше профиль кошелька.'}</p>
  <h3>Фонды</h3>
